...
n_fft = 512
hop_length = 512
path = "/home/kwan/Desktop/"
for step in range(13,14): # step = mfcc의 수 13
    y, sr = librosa.load(path+str(num)+"/CharlesCMann_2018_11_1.wav")
    mfcc_feat = librosa.feature.mfcc(y=y, sr=sr, n_fft=n_fft, hop_length= hop_length, n_mfcc=step)
    ...
    mfcc_feat_1 = librosa.feature.mfcc(y=y1, sr=sr1, n_fft=n_fft, hop_length= hop_length, n_mfcc=step)
    ...
    mfcc_feat_2 = librosa.feature.mfcc(y=y2, sr=sr2, n_fft=n_fft, hop_length= hop_length, n_mfcc=step)
    ...
    mfcc_feat_3 = librosa.feature.mfcc(y=y3, sr=sr3, n_fft=n_fft, hop_length= hop_length, n_mfcc=step)
    ...
    mfcc_feat_4 = librosa.feature.mfcc(y=y4, sr=sr4, n_fft=n_fft, hop_length= hop_length, n_mfcc=step)
    ...
    mfcc_feat_5 = librosa.feature.mfcc(y=y5, sr=sr5, n_fft=n_fft, hop_length= hop_length, n_mfcc=step)
    ...
    mfcc_feat_6 = librosa.feature.mfcc(y=y6, sr=sr6, n_fft=n_fft, hop_length= hop_length, n_mfcc=step)
    ...
    mfcc_feat_7 = librosa.feature.mfcc(y=y7, sr=sr7, n_fft=n_fft, hop_length= hop_length, n_mfcc=step)
    ...
    mfcc_feat_8 = librosa.feature.mfcc(y=y8, sr=sr8, n_fft=n_fft, hop_length= hop_length, n_mfcc=step)
    ...
    for i in range(0, step):
        ...
        _arr_8 = np.array(list_8)
        m8 = np.mean(_arr_8)
        d8 = np.std(_arr_8)
        arr_8 = (_arr_8 - m8) / d8

        _arrd = np.array(listd)
        md = np.mean(_arrd)
        dd = np.std(_arrd)
        arrd = (_arrd - md) / dd
        _arrd_1 = np.array(listd_1)
        md1 = np.mean(_arrd_1)
        dd1 = np.std(_arrd_1)
        arrd_1 = (_arrd_1 - md1) / dd1
        _arrd_2 = np.array(listd_2)
        md2 = np.mean(_arrd_2)
        dd2 = np.std(_arrd_2)
        arrd_2 = (_arrd_2 - md2) / dd2
        _arrd_3 = np.array(listd_3)
        md3 = np.mean(_arrd_3)
        dd3 = np.std(_arrd_3)
        arrd_3 = (_arrd - md) / dd
        _arrd_4 = np.array(listd_4)
        md4 = np.mean(_arrd_4)
        dd4 = np.std(_arrd_4)
        arrd_4 = (_arrd_4 - md4) / dd4
        _arrd_5 = np.array(listd_5)
        md5 = np.mean(_arrd_5)
        dd5 = np.std(_arrd_5)
        arrd_5 = (_arrd_5 - md5) / dd5
        _arrd_6 = np.array(listd_6)
        md6 = np.mean(_arrd_6)
        dd6 = np.std(_arrd_6)
        arrd_6 = (_arrd_6 - md6) / dd6
        _arrd_7 = np.array(listd_7)
        md7 = np.mean(_arrd_7)
        dd7 = np.std(_arrd_7)
        arrd_7 = (_arrd_7 - md7) / dd7
        _arrd_8 = np.array(listd_8)
        md8 = np.mean(_arrd_8)
        dd8 = np.std(_arrd_8)
        arrd_8 = (_arrd_8 - md8) / dd8

        _arrdd = np.array(listdd)
        mdd = np.mean(_arrdd)
        ddd = np.std(_arrdd)
        arrdd = (_arrdd - mdd) / ddd 
        _arrdd_1 = np.array(listdd_1)
        mdd1 = np.mean(_arrdd_1)
        ddd1 = np.std(_arrdd_1)
        arrdd_1 = (_arrdd_1 - mdd1) / ddd1 
        _arrdd_2 = np.array(listdd_2)
        mdd2 = np.mean(_arrdd_2)
        ddd2 = np.std(_arrdd_2)
        arrdd_2 = (_arrdd_2 - mdd2) / ddd2 
        _arrdd_3 = np.array(listdd_3)
        mdd3 = np.mean(_arrdd_3)
        ddd3 = np.std(_arrdd_3)
        arrdd_3 = (_arrdd_3 - mdd3) / ddd3 
        _arrdd_4 = np.array(listdd_4)
        mdd4 = np.mean(_arrdd_4)
        ddd4 = np.std(_arrdd_4)
        arrdd_4 = (_arrdd_4 - mdd4) / ddd4 
        _arrdd_5 = np.array(listdd_5)
        mdd5 = np.mean(_arrdd_5)
        ddd5 = np.std(_arrdd_5)
        arrdd_5 = (_arrdd_5 - mdd5) / ddd5 
        _arrdd_6 = np.array(listdd_6)
        mdd6 = np.mean(_arrdd_6)
        ddd6 = np.std(_arrdd_6)
        arrdd_6 = (_arrdd_6 - mdd6) / ddd6 
        _arrdd_7 = np.array(listdd_7)
        mdd7 = np.mean(_arrdd_7)
        ddd7 = np.std(_arrdd_7)
        arrdd_7 = (_arrdd_7 - mdd7) / ddd7 
        _arrdd_8 = np.array(listdd_8)
        mdd8 = np.mean(_arrdd_8)
        ddd8 = np.std(_arrdd_8)
        arrdd_8 = (_arrdd_8 - mdd8) / ddd8 
        ...
        cost_8, path_8 = fastdtw(arr, arr_8, dist=euclidean)

        costd_1, pathd_1 = fastdtw(arrd, arrd_1, dist=euclidean)
        costd_2, pathd_2 = fastdtw(arrd, arrd_2, dist=euclidean)
        costd_3, pathd_3 = fastdtw(arrd, arrd_3, dist=euclidean)
        costd_4, pathd_4 = fastdtw(arrd, arrd_4, dist=euclidean)
        costd_5, pathd_5 = fastdtw(arrd, arrd_5, dist=euclidean)
        costd_6, pathd_6 = fastdtw(arrd, arrd_6, dist=euclidean)
        costd_7, pathd_7 = fastdtw(arrd, arrd_7, dist=euclidean)
        costd_8, pathd_8 = fastdtw(arrd, arrd_8, dist=euclidean)

        costdd_1, pathdd_1 = fastdtw(arrdd, arrdd_1, dist=euclidean)
        costdd_2, pathdd_2 = fastdtw(arrdd, arrdd_2, dist=euclidean)
        costdd_3, pathdd_3 = fastdtw(arrdd, arrdd_3, dist=euclidean)
        costdd_4, pathdd_4 = fastdtw(arrdd, arrdd_4, dist=euclidean)
        costdd_5, pathdd_5 = fastdtw(arrdd, arrdd_5, dist=euclidean)
        costdd_6, pathdd_6 = fastdtw(arrdd, arrdd_6, dist=euclidean)
        costdd_7, pathdd_7 = fastdtw(arrdd, arrdd_7, dist=euclidean)
        costdd_8, pathdd_8 = fastdtw(arrdd, arrdd_8, dist=euclidean)
    ...
    print("mfcc(12) + delta(13) + delta-delta(13) + normalization + fastdtw")
    ...
    print("ted음성vs8번 음성 평균 거리 : ", dis_8)
    print("\n")
